...
class EventCard extends StatelessWidget{
  ...
  EventCard({required this.launchData});

  //LaunchCardViewModel
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return  ViewModelBuilder<EventCardViewModel>.reactive(
            viewModelBuilder: () => EventCardViewModel(launchData),
                  ...
                  children: [
                         ...
                         children: [
                            Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text("Last updated",overflow: TextOverflow.clip,maxLines: 2,style: TextStyle(fontSize: size.height/55,color: Colors.black),),
                                  )),
                    ...
                    Padding(
                     padding: EdgeInsets.all(size.height/180),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                         borderRadius: BorderRadius.circular(size.height/30),
                         image: DecorationImage(image: NetworkImage("${launchData.featureImage}",),fit: BoxFit.cover)
                    ...
                    Padding(
                     ...
                     padding:  EdgeInsets.all(size.height/90),
                          ...
                          child: Text("Status:)",style: TextStyle(fontSize: size.height/55,color: Colors.black),),
                        ),
                        )),
                    Padding(
                      padding:  EdgeInsets.all(size.height/180),
                            ...
                            Padding(
                             padding:  EdgeInsets.all(size.height/180),
                              ...
                              child: Container(
                                   ...
                                   width: size.width/1.3,
                                child: Text("",overflow: TextOverflow.clip,maxLines: 2,style: TextStyle(fontSize: size.height/55,color: Colors.white),)),
                            ),
                          ],
                        ),
                      ),
                        ...
                        children: [
                          ...
                          padding:  EdgeInsets.all(size.height/90),
                            ...
                            child:Container(
                              ...
                              ),TextSpan(text: "",style: TextStyle(fontSize: size.height/55))
